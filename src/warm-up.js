...
if (pages < 1000) {console.log('I could read that in a day!')}
else {'Ok, maybe I could read that in a day and a half'}
...
if (isFavorite === true) {console.log(`My favorite book is ${title}`)}
...
var books = ['Untamed', 'Wolfpack', 'Becoming', 'Milk & Honey', 'Lord of the Flies'];
...
var belowTwoHundred = [23, 14, 5, 33, 76, 129, 144, 199, 69, 1, 91, 166];
